...
each student to write a short research update and post this to an internal Slack
channel to describe a single plot made during the week (or a calculation, or
discussion points that were raised, etc.).
